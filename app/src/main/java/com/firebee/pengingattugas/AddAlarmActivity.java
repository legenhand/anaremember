...
import com.firebee.pengingattugas.model.DbHelper;


public class AddAlarmActivity extends Activity {
	
//	private static final String TAG = "AddAlarmActivity";
	Button btn_cancel, btn_share;
...
//		timePicker.setCurrentMinute(state.getInt("min"));
	...
	protected void onResume() {
		super.onResume();
		sdf.applyPattern(PengingatTugas.getDateFormat());
	}
	...
	private void findViews() {
		...
		btn_cancel = (Button) findViewById(R.id.hapus);
	...
	private boolean validate() {
		if (TextUtils.isEmpty(msgEdit.getText())) {
			...
			Toast.makeText(this, "Masukkan Mata Pelajaran", Toast.LENGTH_SHORT).show();
			return false;
		}
	...
	public void create(View v) {
		...
		alarm.setKet(ket.getText().toString());
	...
	protected Dialog onCreateDialog(final int id) {
		...
		case DIALOG_ATTIME:
			...
			return new TimePickerDialog(this, mTimeSetListener, cal.get(Calendar.HOUR_OF_DAY), cal.get(Calendar.MINUTE), PengingatTugas.is24Hours());
	...
	public void share(){
		...
		String shareBody = "Mata Pelajaran\t:" +
				...
				"\nKeterangan\t\t:" +
				ket.getText();
		sharingIntent.putExtra(android.content.Intent.EXTRA_SUBJECT, "Tugas" + msgEdit.getText());
	...
	private void showDialog() {
		...
		// set title dialog
		alertDialogBuilder.setTitle("Hapus Data Yang Telah dibuat?");

		// set pesan dari dialog
		alertDialogBuilder
				.setMessage("Semua perubahan tidak akan disimpan!")
