...
import com.firebee.pengingattugas.model.AlarmTime;
...
//	private ViewSwitcher vs;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        int r = PengingatTugas.getDateRange();
		switch(r) {
		case 3: // Yearly
...
//		vs = (ViewSwitcher) findViewById(R.id.view_switcher);
	...
	private String getRangeStr() {
		...
		switch(PengingatTugas.getDateRange()) {
		case 0: // Daily
	...
	private Cursor createCursor() {
		Cursor c = PengingatTugas.dbHelper.listNotifications(db, cal.getTimeInMillis()+move(+1), cal.getTimeInMillis()+move(-1));
		...
		adapter.setViewBinder(new ViewBinder() {
			...
			public boolean setViewValue(View view, Cursor cursor, int columnIndex) {
				...
				case R.id.time_tv:
					...
					String txt = PengingatTugas.showRemainingTime() ? Util.getRemainingTime(time, now) : Util.getActualTime(dt.getHours(), dt.getMinutes());
                    ...
                    ImageView imageView = (ImageView) parent.findViewById(R.id.status);
                    if (time < now) imageView.setImageResource(R.drawable.ic_action_check);
                    else imageView.setImageResource(R.drawable.ic_action_close);
					break;
				}
				return true;
			}
...
/*		case R.id.toggleButton1:
	...
	public boolean onContextItemSelected(MenuItem item) {
		...
		case R.id.menu_delete:
			PengingatTugas.dbHelper.cancelNotification(db, info.id, false);
			refresh = true;
	...
	private void bukadetail() {
		Intent cau = new Intent(MainActivity.this, Main2Activity.class);
	...
	protected Dialog onCreateDialog(int id) {
		...
		case R.id.menu_edit:
		       ...
		       .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
		           public void onClick(DialogInterface dialog, int id) {
		        	   ...
		        	   if (!TextUtils.isEmpty(msgEdit.getText())) {
		        		   ...
		        		   Toast.makeText(MainActivity.this, "Masukkan Mata Pelajaran", Toast.LENGTH_SHORT).show();
		        	   }
		           }
		       })
			...
			case R.id.menu_detail:
				return new AlertDialog.Builder(this)
						.setTitle("Detail")
						.setView(getLayoutInflater().inflate(R.layout.detail, null))
						.setPositiveButton("Share", new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog, int id) {
								Intent sharingIntent = new Intent(android.content.Intent.ACTION_SEND);
								sharingIntent.setType("text/plain");
								String shareBody = "Mata Pelajaran\t:" +
										alarm.getName() +
										"\nKeterangan\t\t:" +
										alarm.getKet();
								sharingIntent.putExtra(android.content.Intent.EXTRA_SUBJECT, "Tugas" + alarm.getName());
	...
	protected void onPrepareDialog(int id, Dialog dialog) {
		...
		case R.id.menu_edit:
			...
			EditText ketEdit = (EditText) dialog.findViewById(R.id.ket);
			msgEdit.setText(alarm.getName());
			ketEdit.setText(alarm.getKet());
			soundCb.setChecked(alarm.getSound());
			break;
            case R.id.menu_detail:
                TextView mapeltext = (TextView) dialog.findViewById(R.id.mapel_text);
                TextView kettext = (TextView) dialog.findViewById(R.id.ket);
                mapeltext.setText(alarm.getName());
                kettext.setText(alarm.getKet());
                break;
		}
	}
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.menu_delete_all:
			...
			PengingatTugas.dbHelper.cancelNotification(db, startTime, endTime);
